...
export default function AuthPage() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#080808', paddingTop:64, display:'flex', alignItems:'center', justifyContent:'center', padding:'80px 20px' }}>
      ...
      <div style={{ width:'100%', maxWidth:440 }}>
        ...
        <div style={{ textAlign:'center', marginBottom:48 }}>
          <div style={{ fontFamily:'Syne,sans-serif', fontWeight:800, fontSize:15, letterSpacing:'-0.02em', color:'#fff', display:'inline-flex', alignItems:'center', gap:10, marginBottom:32 }}>
            <div style={{ width:8, height:8, borderRadius:'50%', background:'#fff' }}/>
            CardProxy
          </div>
          <h1 style={{ fontFamily:'Syne,sans-serif', fontWeight:800, fontSize:'clamp(1.8rem,4vw,2.4rem)', letterSpacing:'-0.03em', lineHeight:1.1, marginBottom:10 }}>
        ...
        {/* Card */}
        <div style={{ background:'#0c0c0c', border:'1px solid #1a1a1a', borderRadius:24, padding:'36px 32px' }}>
          ...
          {/* OAuth placeholder */}
          <button className="btn-pill ghost full" style={{ justifyContent:'center', gap:12 }}>
